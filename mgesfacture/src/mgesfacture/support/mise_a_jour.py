...
monorepo -- ne considère que les tags préfixés "mgesfacture-" (le dépôt
contient aussi mgescompta). Dépôt public : lecture anonyme de l'API, pas de
jeton à gérer.

Vérification manuelle seulement (menu Fichier), jamais au démarrage : évite
de dépendre du réseau pour lancer l'appli. L'installation automatique n'est
...
PREFIXE_TAG = "mgesfacture-"
NOM_EXE = "mgesfacture.exe"
