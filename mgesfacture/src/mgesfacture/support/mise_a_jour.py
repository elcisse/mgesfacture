...
considère que les tags préfixés "mgesfacture-" (le dépôt contient aussi
mgescompta). Dépôt public : lecture anonyme de l'API, pas de jeton à gérer.

Vérification manuelle seulement (menu Fichier), jamais au démarrage : évite
de dépendre du réseau pour lancer l'appli, et n'informe jamais que -- aucun
